...
export const TRONC: NoeudMentorship[] = [
  {
    ...
    theorie: [
      {
        titre: "Fondations",
        texte: "Ce premier niveau porte bien son nom : avant toute spécialisation, il pose les fondations — la mobilité de base, la respiration, la conscience du corps — sur lesquelles tout le reste va se construire. Rien de ce qui suit dans ta pratique ne tiendra sans elles. Chaque exercice de ce niveau a été choisi pour une raison précise, que la théorie ci-dessous t'explique : comprendre pourquoi tu fais ce que tu fais est déjà une partie du travail.",
      },
      {
        titre: "Qu'est-ce que le Mouvement ?",
        texte: "Le Mouvement est une quête, une démarche de recherche et de développement personnel, un point de vue et une stratégie à la fois physique et mentale, axée sur l'apprentissage et l'acquisition d'expérience. Peut-on le qualifier de pratique ou de discipline ? Oui, car il se distingue par sa démarche, sa communauté et un domaine de pratique fortement identitaire. Mais il reste difficile à catégoriser, du fait de sa grande diversité de formes et de sa capacité de mutation — et plus on essaie de le résumer ou de le justifier, plus on s'éloigne de son sens profond. En pratique, un mouvement ne se discute pas, il se fait. Pourtant, en y regardant de plus près, tout mouvement est porteur d'une intention, d'une motivation : c'est sur ce point que tu dois ancrer ta démarche.",
      },
      {
        titre: "Y a-t-il de bons et de mauvais mouvements ?",
        texte: "Derrière chaque mouvement se cache une intention. Cette intention peut être inadaptée — trop ambitieuse pour les capacités du moment, ou mal orientée. Les outils choisis peuvent aussi être en décalage avec l'objectif du travail. Mais en toute logique, il n'existe pas de bon ou de mauvais mouvement dans l'absolu : seulement des mouvements que nous sommes prêts à réaliser, et d'autres pas encore. Tout l'enjeu de ce parcours est de te rendre prêt, progressivement, à des mouvements de plus en plus exigeants.",
      },
      {
        titre: "Pourquoi bouger ?",
        texte: "Comme le souligne Daniel Goleman dans « L'intelligence émotionnelle », le mot émotion vient du latin motere, « mouvoir », précédé du préfixe é-, qui indique un mouvement vers l'extérieur : nos émotions nous poussent à agir. Mais les stimulus qui poussaient nos ancêtres à bouger ne font plus partie du quotidien de la plupart d'entre nous, ce qui crée une perte de repères aux conséquences autant mentales que physiques (sédentarité, pathologies articulaires précoces). L'observation du vivant par les évolutionnistes — Lamarck et le rapport de dépendance entre la fonction et l'organe, Darwin et la sélection naturelle — nous donne un indice majeur : notre corps a été façonné par des millions d'années d'évolution en pleine nature, contre quelques milliers d'années d'agriculture et à peine quelques centaines d'années de vie moderne. Qu'on les utilise ou non, il a conservé en mémoire ses capacités originelles : mobilité articulaire, force, habileté, créativité. Impossible de toutes les porter à leur maximum, mais tout à fait possible de les réapprendre et de les développer. D'où le constat popularisé par Ido Portal : « Move because you can ! »",
      },
      {
        titre: "Les bienfaits du Mouvement",
        texte: "Le mouvement caractérise la vie. Il stimule nos circulations : sanguine d'abord, car la contraction des grands muscles des jambes — comme dans un squat — agit comme une pompe qui aide le sang à remonter vers le cœur ; lymphatique ensuite, que les balanciers, les frappes et les sauts favorisent. Il stimule aussi nos organes d'élimination, notre production de chaleur et notre digestion. Au niveau cérébral, l'apprentissage du mouvement stimule notre production hormonale et entretient la myéline de notre réseau nerveux ainsi que la matière grise, ce qui nous rend plus adaptables, réactifs et créatifs : c'est la plasticité cérébrale. En mettant notre organisme à l'épreuve de façon dosée, il déclenche des réponses d'adaptation — le principe d'hormèse : une contrainte modérée rend plus fort, là où une contrainte excessive épuise. Enfin, il redonne élasticité et résilience à nos tissus conjonctifs, élargit le diamètre de nos tendons et augmente notre densité osseuse, surtout avec la charge et les impacts — un effet aujourd'hui bien documenté, plusieurs méta-analyses confirmant que le travail contre résistance améliore la densité minérale osseuse, notamment à la hanche et à la colonne. Le Mouvement freine ainsi notre inévitable dégénérescence. Pratiqué avec intelligence, dans une logique d'harmonie et de santé sur le long terme, il n'est pas contradictoire avec la performance : il la met au service de la santé.",
      },
      {
        titre: "Descendre au sol et s'en relever : un indicateur de santé",
        texte: "Le deep squat de ce niveau n'est pas un simple étirement : c'est une porte d'entrée vers le sol, une transition entre la station debout et toutes les positions plus basses. Cette capacité est un marqueur de santé étonnamment puissant. En 2014, une équipe brésilienne a fait passer un test très simple à 2 002 adultes de 51 à 80 ans : s'asseoir au sol puis se relever, en perdant un point à chaque appui utilisé (main, genou, avant-bras). Plus le score était faible, plus le risque de décès au cours des années suivantes était élevé (Brito et al., European Journal of Preventive Cardiology). Il s'agit d'une association, pas d'une preuve que le test lui-même protège — mais elle montre ce qu'il résume : force, souplesse, équilibre et coordination, réunies dans un geste du quotidien. Ta pratique du squat profond construit exactement ces qualités.",
      },
      {
        titre: "La force de préhension : bien plus qu'une question de mains",
        texte: "La suspension de ce niveau travaille ton grip, souvent négligé. Or la force de préhension est l'un des indicateurs de santé les plus étudiés. Dans l'étude PURE, menée sur près de 140 000 adultes de 35 à 70 ans dans 17 pays, chaque baisse de 5 kg de force de préhension était associée à une augmentation d'environ 16 % du risque de mortalité toutes causes — un indicateur plus prédictif que la pression artérielle systolique (Leong et al., The Lancet, 2015). Là encore, c'est une association : la force de la main reflète en réalité l'état de toute la masse musculaire et la capacité du corps à rester actif. D'où l'importance de verrouiller correctement ta prise et de nourrir ce travail même en dehors des séances.",
      },
      {
        titre: "Respirer lentement, par le nez",
        texte: "La respiration est la seule fonction automatique que l'on peut aussi contrôler volontairement, ce qui en fait une porte d'accès directe au système nerveux. Au repos, un adulte respire spontanément autour de 12 à 20 cycles par minute. Ralentir volontairement ce rythme, vers environ 6 cycles par minute, augmente la variabilité de la fréquence cardiaque — un marqueur de l'activité du système parasympathique, celui du repos et de la récupération — et fait baisser la tension artérielle pendant et juste après la séance, comme l'ont montré plusieurs méta-analyses récentes. Respirer par le nez, à l'inspiration comme à l'expiration, ralentit naturellement le souffle et favorise une respiration diaphragmatique. C'est tout le sens de The perfect breath : ce n'est pas une performance, c'est un apprentissage du calme, qui demande de la durée pour produire son effet.",
      },
      {
        titre: "L'armure organique : la métaphore du forgeron",
        texte: "Les mains d'un forgeron s'adaptent au fil du temps à son travail : des callosités se forment en réponse aux frictions répétées, ses mains, ses poignets et ses avant-bras se renforcent. Elles deviennent un mélange de rigidité, pour tenir fermement les outils, et de souplesse, pour les gestes délicats. C'est exactement cette dynamique d'adaptation que symbolise l'« armure organique » : le mot « armure » (du latin armatura) évoque une protection, un rempart contre les agressions extérieures ; « organique » (du grec organikos) évoque ce qui est vivant, capable de croître et de s'adapter. L'armure organique n'est donc pas une protection statique, mais un système dynamique, forgé non pas de métal mais de muscles, d'os, de tendons et d'une conscience aiguë du corps. Ce premier niveau en pose les toutes premières pièces.",
      },
    ],
    programmation: [
      {
  ...
  },
  {
    ...
    theorie: [
      {
        titre: "Consolidation",
        texte: "Ce deuxième niveau porte bien son nom : ce que tu as posé en Fondations se consolide ici. Tes outils gagnent en exigence, ta pratique devient plus méthodique. On ne construit pas encore de nouvelles fondations : on solidifie celles qui existent, et on apprend à mesurer sa progression.",
      },
      {
        titre: "Les cinq qualités de l'armure organique",
        texte: "L'armure organique se compose de cinq qualités. La Structure : une densité osseuse importante et une masse musculaire structurelle (les muscles profonds) dense et tonique. L'Équilibre : une masse musculaire « utile », apportant une tenségrité optimale et harmonieuse. La Flexibilité : un corps capable de se déformer, de se plier et de s'étirer de multiples façons. La Résilience : un corps capable de résister à de fortes contraintes puis de retrouver son état d'équilibre. La Connexion : un corps « disponible », dont chaque partie peut être ressentie et utilisée indépendamment, alternativement ou simultanément, avec la plus grande vivacité comme avec la plus grande lenteur.",
      },
      {
        titre: "La tenségrité, ou l'équilibre des tensions",
        texte: "Le mot tenségrité vient de l'architecture : il désigne une structure qui tient debout non pas grâce à l'empilement de pièces rigides, mais grâce à l'équilibre entre des éléments qui résistent à la compression et un réseau continu d'éléments en tension. Appliqué au corps, c'est un modèle — pas une vérité anatomique figée — mais un modèle très parlant : les os résistent à la compression, les muscles, tendons et fascias forment le réseau de tension. Une tension excessive ou insuffisante à un endroit se répercute sur l'ensemble. C'est pourquoi l'armure organique recherche une masse musculaire « utile » et répartie, plutôt que le développement isolé de quelques muscles.",
      },
      {
        titre: "Le travail de fond : du subjectif vers l'objectif",
        texte: "Le travail de fond est d'abord subjectif : il s'adapte aux besoins et aux capacités de chacun. Il est comparable à l'œuvre qui se transforme sous les mains du forgeron : chaque coup de marteau, répété des centaines voire des milliers de fois, contribue à la forme finale. De la même façon, tes routines articulaires et musculaires doivent être exécutées avec une grande régularité pour développer les qualités recherchées — elles sont la base sur laquelle repose toute la progression future. Vient ensuite un travail plus objectif, orienté vers des objectifs précis et mesurables : c'est ce que tu commences à faire à ce niveau, avec des critères de validation chiffrés, des temps de récupération définis, des pourcentages de travail.",
      },
      {
        titre: "Le travail en profondeur",
        texte: "Quel est le point commun entre un musicien professionnel, un sportif de haut niveau et un artiste peintre ? Le travail approfondi. Bâtir des compétences solides repose sur un procédé inspiré de l'évolution biologique elle-même : la répétition (test, erreur, test, erreur…). Réalisée avec conscience et analyse, elle améliore progressivement la qualité d'exécution. Les neurosciences l'ont confirmé chez l'humain : dès 2009, une équipe d'Oxford a montré que l'apprentissage du jonglage modifiait la structure de la substance blanche du cerveau chez des adultes (Scholz et al., Nature Neuroscience), et des travaux sur l'animal ont depuis montré que la production de nouvelle myéline est nécessaire pour maîtriser une nouvelle tâche motrice complexe. Autrement dit : plus une action est répétée avec attention, en volume et en fréquence, plus elle s'inscrit durablement dans le système nerveux.",
      },
      {
        titre: "Une compétence se nourrit, ou elle s'en va",
        texte: "La logique s'inverse pour les compétences dont on ne se sert plus. Une compétence est comme un petit animal de compagnie : si on veut qu'elle reste, il faut la nourrir régulièrement. Un grand écart construit pendant des mois se perd s'il n'est jamais remis à profit dans un projet plus vaste et plus stimulant. Il est donc capital de savoir pourquoi tu développes telle ou telle compétence, au risque de perdre ton temps. On cite souvent le chiffre de 10 000 heures de pratique pour maîtriser un domaine. La recherche récente nuance ce chiffre : une vaste méta-analyse a estimé que la pratique délibérée explique environ 18 % des différences de performance dans le sport (Macnamara et al., 2014). La pratique est donc indispensable, mais elle n'explique pas tout — sa qualité, sa régularité et son sens comptent autant que la quantité.",
      },
      {
        titre: "Chaque compétence a son prix",
        texte: "La pratique du mouvement comporte-t-elle des risques ? Comme toute pratique, chaque compétence possède son étiquette de prix, et ce prix varie d'une personne à l'autre : nous n'avons pas tous le même capital de départ, ni la même façon de faire nos comptes avant de passer en caisse. S'engager pleinement est un moyen efficace de progresser, mais il vaut mieux ne pas y laisser sa santé. C'est donc à toi de fixer des limites réalistes et intelligentes à ta pratique, et surtout de ne pas te comparer aux autres : on ne peut jamais donner plus que ce que l'on a. C'est tout le sens des règles de ce niveau — travailler à 80 % de son maximum, respecter les temps de récupération : elles permettent de progresser sans s'abîmer.",
      },
      {
        titre: "L'état d'esprit du débutant",
        texte: "L'état d'esprit du débutant — le soshin, dans la tradition zen — ouvert et avide d'expériences, doit rester actif dans ta manière d'aborder la pratique, sous peine de te décevoir continuellement. De même qu'on ne juge pas un débutant en apprentissage, un débutant ne devrait pas se juger lui-même et oublier d'où il vient. Une réussite se construit, et elle sera toujours le fruit d'un travail — donc de nombreuses erreurs. Considère ton apprentissage comme une expérience intense qui t'apportera bien plus que la santé : tu y apprendras énormément sur toi-même, sur tes capacités et tes limites.",
      },
      {
        titre: "Une bibliothèque qui grandit",
        texte: "À ce niveau, ta pratique de récupération et de bien-être s'enrichit : chaque nouvel outil rejoint ceux déjà acquis, pour te constituer une véritable bibliothèque de routines mobilisables selon ton besoin du moment. Ce n'est pas un remplacement du travail précédent, mais un ajout.",
      },
    ],
    programmation: [
      {
  ...
  },
  {
    ...
    theorie: [
      {
        titre: "Intégration",
        texte: "Ce troisième niveau porte bien son nom : les outils travaillés en Fondations et en Consolidation s'intègrent maintenant les uns aux autres, et ton corps apprend à fonctionner comme un tout. Ce niveau pose aussi les grands principes qui porteront toute la suite de ta pratique, quel que soit le domaine.",
      },
      {
        titre: "La répétition, matière première de l'entraînement",
        texte: "Chaque mouvement trouve sa qualité dans la répétition. Mais répéter ne veut pas dire refaire mécaniquement le même geste : le physiologiste russe Nikolaï Bernstein parlait de « répétition sans répétition ». Chaque essai est légèrement différent du précédent, et c'est précisément cette variation, observée et corrigée, qui permet au système nerveux de trouver la meilleure solution. Répéter régulièrement et consciemment un mouvement permet de le comprendre en profondeur et de forger une connexion solide entre le corps et l'esprit — la base de tout apprentissage durable. C'est aussi pour cela que les consignes de ce niveau imposent un tempo précis ou un nombre de répétitions limité : la qualité de chaque répétition compte plus que leur nombre.",
      },
      {
        titre: "L'ambidextrie, l'équilibre entre les deux côtés",
        texte: "Développer la capacité à utiliser les deux côtés du corps de manière équilibrée renforce la coordination globale et la conscience corporelle. La science apporte ici un argument étonnant : entraîner un seul membre fait aussi progresser le membre opposé, non entraîné. Ce phénomène, appelé éducation croisée, représente en moyenne un gain de force d'environ 12 % du côté non travaillé (Manca et al., 2017), et il s'explique par des adaptations du système nerveux plutôt que du muscle. Ton côté fort peut donc réellement soutenir et « enseigner » ton côté faible — à condition de ne jamais oublier de travailler ce dernier directement, car rien ne remplace le travail direct.",
      },
      {
        titre: "L'analyse de l'erreur",
        texte: "Les erreurs sont des informations, pas des échecs. Les analyser en profondeur permet de comprendre les lacunes et de les transformer en occasions de progresser. Pour que cette analyse porte ses fruits, la progression doit suivre une démarche évolutive : des objectifs accessibles, de difficulté toujours croissante, et interdépendants. Chaque compétence doit être suffisamment stable avant de passer à la suivante, car elle servira de base à un objectif de niveau supérieur. Et pense à célébrer chaque étape franchie, aussi petite soit-elle : c'est ce qui entretient la confiance et la motivation sur la durée.",
      },
      {
        titre: "Les avantages de la pratique généraliste",
        texte: "Sortir de sa zone de confort et développer un large éventail de compétences, au-delà de ses goûts et de ses limites mentales du moment : voilà ce qu'encourage une pratique généraliste. La recherche va dans ce sens. Une méta-analyse de 2022 portant sur 6 096 athlètes, dont 772 parmi les meilleurs au monde, a montré que les athlètes de niveau mondial avaient pratiqué davantage de sports différents pendant l'enfance et l'adolescence, commencé leur discipline principale plus tard, et progressé plus lentement au début que les athlètes de niveau national (Güllich, Macnamara et Hambrick). Une base large ralentit parfois les premiers progrès, mais elle rend le développement plus durable. Elle favorise la transversalité des compétences et la capacité d'adaptation — des atouts majeurs pour la santé, la performance et la longévité.",
      },
      {
        titre: "La fabrique du multivers",
        texte: "À ce stade, chaque compétence acquise devient une brique dans la construction d'un multivers de mouvements : un univers où les compétences ne s'additionnent pas simplement, mais se combinent, se transfèrent et en génèrent de nouvelles. Une mobilité de cheville construite pour le squat profond servira demain dans des dizaines de mouvements que tu ne connais pas encore. C'est ce transfert qui rend la pratique du Mouvement si riche, et qui favorise à la fois le dépassement de soi et la créativité.",
      },
      {
        titre: "Ouvrir des portes",
        texte: "L'armure organique a pour but d'ouvrir des portes. L'exploration commence par l'acquisition de compétences fondamentales, des tremplins vers des objectifs plus avancés — les « Grandes Portes » de ton parcours. Ce niveau termine cette phase : il rend abordables, en même temps, les premiers objectifs des cinq branches. C'est pour cela qu'une fois l'armure organique complète, tu débloques le niveau 1 de Force, Figures, Flexibilité, Locomotion et Connexion en même temps — pas une branche après l'autre. L'armure, elle, ne sera jamais achevée : c'est une œuvre en progression, qui continuera de s'adapter à tes compétences et à tes aspirations. Le schéma ci-dessous représente les cinq branches qui s'ouvrent à toi : elles se chevauchent volontairement, car aucune ne se pratique jamais complètement isolée des autres — la « zone passerelle » au centre symbolise tout ce qui les relie, et que tu retrouveras au fil de la théorie de chaque branche.",
