...
export type FragmentTheorie = {
  titre: string;
  sousTitre?: string; // accroche courte sous le titre (une ligne)
  texte: string; // paragraphes séparés par une ligne vide ("\n\n")
  aRetenir?: string; // idée clé, affichée dans un encadré
  source?: string; // référence scientifique ou bibliographique, affichée en pied de section
  image?: string; // illustration optionnelle (schéma, diagramme) dans /public/mentorship/theorie
  legende?: string; // légende affichée sous l'image
};
...
export const TRONC: NoeudMentorship[] = [
  {
    ...
    theorie: [
      {
        titre: "Fondations",
        sousTitre: "Le point de départ commun à tout le reste",
        texte: "Ce premier niveau porte bien son nom : avant toute spécialisation, il pose les fondations — la mobilité de base, la respiration, la conscience du corps — sur lesquelles tout le reste va se construire. Rien de ce qui suit dans ta pratique ne tiendra sans elles.\n\nChaque exercice de ce niveau a été choisi pour une raison précise, que la théorie ci-dessous t'explique. Comprendre pourquoi tu fais ce que tu fais est déjà une partie du travail.",
      },
      {
        titre: "Qu'est-ce que le Mouvement ?",
        sousTitre: "Une quête, avant d'être une discipline",
        texte: "Le Mouvement est une quête, une démarche de recherche et de développement personnel, un point de vue et une stratégie à la fois physique et mentale, axée sur l'apprentissage et l'acquisition d'expérience.\n\nPeut-on le qualifier de pratique ou de discipline ? Oui, car il se distingue par sa démarche, sa communauté et un domaine de pratique fortement identitaire. Mais il reste difficile à catégoriser, du fait de sa grande diversité de formes et de sa capacité de mutation — et plus on essaie de le résumer ou de le justifier, plus on s'éloigne de son sens profond.\n\nEn pratique, un mouvement ne se discute pas, il se fait. Pourtant, en y regardant de plus près, tout mouvement est porteur d'une intention, d'une motivation.",
        aRetenir: "Tout mouvement porte une intention : c'est sur elle que tu dois ancrer ta démarche.",
      },
      {
        titre: "Y a-t-il de bons et de mauvais mouvements ?",
        sousTitre: "Seulement des mouvements pour lesquels on est prêt, ou pas encore",
        texte: "Derrière chaque mouvement se cache une intention. Cette intention peut être inadaptée — trop ambitieuse pour les capacités du moment, ou mal orientée. Les outils choisis peuvent aussi être en décalage avec l'objectif du travail.\n\nMais en toute logique, il n'existe pas de bon ou de mauvais mouvement dans l'absolu : seulement des mouvements que nous sommes prêts à réaliser, et d'autres pas encore. Tout l'enjeu de ce parcours est de te rendre prêt, progressivement, à des mouvements de plus en plus exigeants.",
        aRetenir: "Un mouvement n'est pas bon ou mauvais en soi : la question est de savoir si tu es prêt à le réaliser.",
      },
      {
        titre: "Pourquoi bouger ?",
        sousTitre: "Un corps façonné par des millions d'années de mouvement",
        texte: "Le mot émotion vient du latin motere, « mouvoir », précédé du préfixe é-, qui indique un mouvement vers l'extérieur : nos émotions nous poussent à agir. Mais les stimulus qui poussaient nos ancêtres à bouger ne font plus partie du quotidien de la plupart d'entre nous, ce qui crée une perte de repères aux conséquences autant mentales que physiques (sédentarité, pathologies articulaires précoces).\n\nL'observation du vivant par les évolutionnistes — Lamarck et le rapport de dépendance entre la fonction et l'organe, Darwin et la sélection naturelle — nous donne un indice majeur : notre corps a été façonné par des millions d'années d'évolution en pleine nature, contre quelques milliers d'années d'agriculture et à peine quelques centaines d'années de vie moderne.\n\nQu'on les utilise ou non, il a conservé en mémoire ses capacités originelles : mobilité articulaire, force, habileté, créativité. Impossible de toutes les porter à leur maximum, mais tout à fait possible de les réapprendre et de les développer. D'où le constat popularisé par Ido Portal : « Move because you can ! »",
        source: "Daniel Goleman, L'intelligence émotionnelle.",
      },
      {
        titre: "Les bienfaits du Mouvement",
        sousTitre: "Circulations, cerveau, tissus : un corps entier qui s'adapte",
        texte: "Le mouvement stimule nos circulations : sanguine d'abord, car la contraction des grands muscles des jambes — comme dans un squat — agit comme une pompe qui aide le sang à remonter vers le cœur ; lymphatique ensuite, que les balanciers, les frappes et les sauts favorisent. Il stimule aussi nos organes d'élimination, notre production de chaleur et notre digestion.\n\nAu niveau cérébral, l'apprentissage du mouvement stimule notre production hormonale et entretient la myéline de notre réseau nerveux ainsi que la matière grise, ce qui nous rend plus adaptables, réactifs et créatifs : c'est la plasticité cérébrale.\n\nEn mettant l'organisme à l'épreuve de façon dosée, il déclenche des réponses d'adaptation. C'est le principe d'hormèse : une contrainte modérée rend plus fort, là où une contrainte excessive épuise.\n\nEnfin, il redonne élasticité et résilience aux tissus conjonctifs, élargit le diamètre des tendons et augmente la densité osseuse, surtout avec la charge et les impacts. Pratiqué avec intelligence, dans une logique de santé sur le long terme, le Mouvement n'est pas contradictoire avec la performance : il la met au service de la santé.",
        aRetenir: "Une contrainte bien dosée rend plus fort : c'est tout le principe de l'entraînement.",
        source: "Plusieurs méta-analyses récentes confirment que le travail contre résistance améliore la densité minérale osseuse, notamment à la hanche et à la colonne.",
      },
      {
        titre: "Descendre au sol et s'en relever",
        sousTitre: "Un geste simple, et un indicateur de santé puissant",
        texte: "Le deep squat de ce niveau n'est pas un simple étirement : c'est une porte d'entrée vers le sol, une transition entre la station debout et toutes les positions plus basses.\n\nCette capacité est un marqueur de santé étonnamment puissant. Une équipe brésilienne a fait passer un test très simple à 2 002 adultes de 51 à 80 ans : s'asseoir au sol puis se relever, en perdant un point à chaque appui utilisé (main, genou). Plus le score était faible, plus le risque de décès au cours des années suivantes était élevé.\n\nIl s'agit d'une association, pas d'une preuve que le test lui-même protège. Mais elle montre ce qu'il résume : force, souplesse, équilibre et coordination, réunies dans un geste du quotidien. Ta pratique du squat profond construit exactement ces qualités.",
        aRetenir: "Savoir descendre au sol et s'en relever sans aide résume à lui seul force, souplesse et équilibre.",
        source: "Brito et al., « Ability to sit and rise from the floor as a predictor of all-cause mortality », European Journal of Preventive Cardiology, 2014.",
      },
      {
        titre: "La force de préhension",
        sousTitre: "Bien plus qu'une question de mains",
        texte: "La suspension de ce niveau travaille ton grip, souvent négligé. Or la force de préhension est l'un des indicateurs de santé les plus étudiés.\n\nDans l'étude PURE, menée sur près de 140 000 adultes de 35 à 70 ans dans 17 pays, chaque baisse de 5 kg de force de préhension était associée à une augmentation d'environ 16 % du risque de mortalité toutes causes. Elle s'est même révélée plus prédictive que la pression artérielle systolique.\n\nLà encore, c'est une association : la force de la main reflète en réalité l'état de toute la masse musculaire et la capacité du corps à rester actif. D'où l'importance de verrouiller correctement ta prise et de nourrir ce travail même en dehors des séances.",
        aRetenir: "Ton grip reflète l'état de toute ta musculature : il mérite d'être entretenu comme une qualité à part entière.",
        source: "Leong et al., « Prognostic value of grip strength: findings from the PURE study », The Lancet, 2015.",
      },
      {
        titre: "Respirer lentement, par le nez",
        sousTitre: "La respiration, porte d'accès directe au système nerveux",
        texte: "La respiration est la seule fonction automatique que l'on peut aussi contrôler volontairement. Au repos, un adulte respire spontanément autour de 12 à 20 cycles par minute.\n\nRalentir volontairement ce rythme, vers environ 6 cycles par minute, augmente la variabilité de la fréquence cardiaque — un marqueur de l'activité du système parasympathique, celui du repos et de la récupération — et fait baisser la tension artérielle pendant et juste après la séance.\n\nRespirer par le nez, à l'inspiration comme à l'expiration, ralentit naturellement le souffle et favorise une respiration diaphragmatique. C'est tout le sens de The perfect breath : ce n'est pas une performance, c'est un apprentissage du calme, qui demande de la durée pour produire son effet.",
        aRetenir: "Ralentir son souffle, c'est agir directement sur son système nerveux : le calme s'entraîne.",
        source: "Laborde et al., méta-analyse sur la respiration lente et la variabilité cardiaque, Neuroscience & Biobehavioral Reviews, 2022 ; Shao et al., méta-analyse de 31 études, 2024.",
      },
      {
        titre: "L'armure organique : la métaphore du forgeron",
        sousTitre: "Une protection vivante, qui se forge et s'adapte",
        texte: "Les mains d'un forgeron s'adaptent au fil du temps à son travail : des callosités se forment en réponse aux frictions répétées, ses mains, ses poignets et ses avant-bras se renforcent. Elles deviennent un mélange de rigidité, pour tenir fermement les outils, et de souplesse, pour les gestes délicats.\n\nC'est exactement cette dynamique d'adaptation que symbolise l'« armure organique ». Le mot « armure » (du latin armatura) évoque une protection, un rempart contre les agressions extérieures ; « organique » (du grec organikos) évoque ce qui est vivant, capable de croître et de s'adapter.\n\nL'armure organique n'est donc pas une protection statique, mais un système dynamique, forgé non pas de métal mais de muscles, d'os, de tendons et d'une conscience aiguë du corps. Ce premier niveau en pose les toutes premières pièces.",
        aRetenir: "L'armure organique n'est pas une carapace figée : c'est un système vivant qui se forge par la répétition.",
      },
    ],
    programmation: [
      {
    ...
    qcm: [
      {
        id: 'armure1-q1',
        question: "Dans le hollow hold, quel contact avec le sol est attendu ?",
        choix: ["Lombaires écrasées au sol, omoplates décollées", "Lombaires et omoplates plaquées au sol", "Omoplates au sol, bassin neutre pour protéger la nuque"],
        bonneReponse: 0,
      },
      {
        id: 'armure1-q2',
        question: "En suspension active, quel repère montre que les omoplates sont engagées ?",
        choix: ["La tête rentre entre les épaules", "La tête sort des épaules", "Les coudes se fléchissent légèrement pour soulager l'articulation"],
        bonneReponse: 1,
      },
      {
        id: 'armure1-q3',
        question: "Quelle consigne respiratoire est donnée pour The perfect breath ?",
        choix: ["Inspiration par le nez, expiration longue par la bouche", "Inspiration par la bouche, expiration lente par le nez", "Inspiration et expiration par le nez"],
        bonneReponse: 2,
      },
      {
        id: 'armure1-q4',
        question: "Selon la philosophie du Mouvement, qu'est-ce qui rend un mouvement adapté à un pratiquant ?",
        choix: ["Sa conformité à un standard technique de référence", "Son faible risque de blessure", "Le fait que le pratiquant soit prêt à le réaliser"],
        bonneReponse: 2,
      },
    ],
    contenuDefini: true,
  ...
  },
  {
    ...
    theorie: [
      {
        titre: "Consolidation",
        sousTitre: "Solidifier ce qui a été posé, et apprendre à mesurer",
        texte: "Ce deuxième niveau porte bien son nom : ce que tu as posé en Fondations se consolide ici. Tes outils gagnent en exigence, ta pratique devient plus méthodique.\n\nOn ne construit pas encore de nouvelles fondations : on solidifie celles qui existent, et on apprend à mesurer sa progression.",
      },
      {
        titre: "Les cinq qualités de l'armure organique",
        sousTitre: "Structure, Équilibre, Flexibilité, Résilience, Connexion",
        texte: "La Structure : une densité osseuse importante et une masse musculaire structurelle (les muscles profonds) dense et tonique.\n\nL'Équilibre : une masse musculaire « utile », apportant une tenségrité optimale et harmonieuse.\n\nLa Flexibilité : un corps capable de se déformer, de se plier et de s'étirer de multiples façons.\n\nLa Résilience : un corps capable de résister à de fortes contraintes puis de retrouver son état d'équilibre.\n\nLa Connexion : un corps « disponible », dont chaque partie peut être ressentie et utilisée indépendamment, alternativement ou simultanément, avec la plus grande vivacité comme avec la plus grande lenteur.",
      },
      {
        titre: "La tenségrité, ou l'équilibre des tensions",
        sousTitre: "Un modèle venu de l'architecture pour comprendre le corps",
        texte: "Le mot tenségrité vient de l'architecture : il désigne une structure qui tient debout non pas grâce à l'empilement de pièces rigides, mais grâce à l'équilibre entre des éléments qui résistent à la compression et un réseau continu d'éléments en tension.\n\nAppliqué au corps, c'est un modèle — pas une vérité anatomique figée — mais un modèle très parlant : les os résistent à la compression, les muscles, tendons et fascias forment le réseau de tension. Une tension excessive ou insuffisante à un endroit se répercute sur l'ensemble.\n\nC'est pourquoi l'armure organique recherche une masse musculaire « utile » et répartie, plutôt que le développement isolé de quelques muscles.",
        aRetenir: "Dans un corps, tout est relié : un déséquilibre local se répercute sur l'ensemble.",
      },
      {
        titre: "Le travail de fond",
        sousTitre: "Du subjectif vers l'objectif",
        texte: "Le travail de fond est d'abord subjectif : il s'adapte aux besoins et aux capacités de chacun. Il est comparable à l'œuvre qui se transforme sous les mains du forgeron : chaque coup de marteau, répété des centaines voire des milliers de fois, contribue à la forme finale.\n\nDe la même façon, tes routines articulaires et musculaires doivent être exécutées avec une grande régularité pour développer les qualités recherchées. Elles sont la base sur laquelle repose toute la progression future.\n\nVient ensuite un travail plus objectif, orienté vers des objectifs précis et mesurables. C'est ce que tu commences à faire à ce niveau, avec des critères de validation chiffrés, des temps de récupération définis, des pourcentages de travail.",
        aRetenir: "La régularité construit la base ; la mesure permet ensuite de progresser avec méthode.",
      },
      {
        titre: "Le travail en profondeur",
        sousTitre: "Ce que la répétition change dans le cerveau",
        texte: "Quel est le point commun entre un musicien professionnel, un sportif de haut niveau et un artiste peintre ? Le travail approfondi. Bâtir des compétences solides repose sur un procédé inspiré de l'évolution biologique elle-même : la répétition (test, erreur, test, erreur…).\n\nRéalisée avec conscience et analyse, elle améliore progressivement la qualité d'exécution. Les neurosciences l'ont confirmé chez l'humain : l'apprentissage du jonglage modifie la structure de la substance blanche du cerveau chez des adultes. Des travaux sur l'animal ont depuis montré que la production de nouvelle myéline est nécessaire pour maîtriser une nouvelle tâche motrice complexe.\n\nAutrement dit : plus une action est répétée avec attention, en volume et en fréquence, plus elle s'inscrit durablement dans le système nerveux.",
        aRetenir: "Répéter avec attention, c'est littéralement construire les circuits nerveux du geste : la myélinisation.",
        source: "Daniel Coyle, Le talent code, 2009 ; Scholz et al., « Training induces changes in white-matter architecture », Nature Neuroscience, 2009.",
      },
      {
        titre: "Une compétence se nourrit, ou elle s'en va",
        sousTitre: "Pratiquer beaucoup ne suffit pas : il faut pratiquer avec sens",
        texte: "La logique s'inverse pour les compétences dont on ne se sert plus. Une compétence est comme un petit animal de compagnie : si on veut qu'elle reste, il faut la nourrir régulièrement. Un grand écart construit pendant des mois se perd s'il n'est jamais remis à profit dans un projet plus vaste et plus stimulant.\n\nIl est donc capital de savoir pourquoi tu développes telle ou telle compétence, au risque de perdre ton temps.\n\nOn cite souvent le chiffre de 10 000 heures de pratique pour maîtriser un domaine. La recherche récente nuance ce chiffre : la pratique délibérée expliquerait environ 18 % des différences de performance dans le sport. Elle est donc indispensable, mais elle n'explique pas tout — sa qualité, sa régularité et son sens comptent autant que la quantité.",
        aRetenir: "Une compétence non entretenue se perd : sache toujours pourquoi tu la travailles.",
        source: "Macnamara, Hambrick et Oswald, méta-analyse sur la pratique délibérée, Psychological Science, 2014.",
      },
      {
        titre: "Chaque compétence a son prix",
        sousTitre: "Progresser sans s'abîmer",
        texte: "La pratique du mouvement comporte-t-elle des risques ? Comme toute pratique, chaque compétence possède son étiquette de prix, et ce prix varie d'une personne à l'autre : nous n'avons pas tous le même capital de départ, ni la même façon de faire nos comptes avant de passer en caisse.\n\nS'engager pleinement est un moyen efficace de progresser, mais il vaut mieux ne pas y laisser sa santé. C'est donc à toi de fixer des limites réalistes et intelligentes à ta pratique, et surtout de ne pas te comparer aux autres : on ne peut jamais donner plus que ce que l'on a.\n\nC'est tout le sens des règles de ce niveau — travailler à 80 % de son maximum, respecter les temps de récupération : elles permettent de progresser sans s'abîmer.",
        aRetenir: "Ne te compare pas aux autres : ton point de départ et tes limites te sont propres.",
      },
      {
        titre: "L'état d'esprit du débutant",
        sousTitre: "Le soshin, ou l'art de rester ouvert",
        texte: "L'état d'esprit du débutant — le soshin, dans la tradition zen — ouvert et avide d'expériences, doit rester actif dans ta manière d'aborder la pratique, sous peine de te décevoir continuellement.\n\nDe même qu'on ne juge pas un débutant en apprentissage, un débutant ne devrait pas se juger lui-même et oublier d'où il vient. Une réussite se construit, et elle sera toujours le fruit d'un travail — donc de nombreuses erreurs.\n\nConsidère ton apprentissage comme une expérience intense qui t'apportera bien plus que la santé : tu y apprendras énormément sur toi-même, sur tes capacités et tes limites.",
        aRetenir: "Toute réussite est faite d'erreurs : ne te juge pas plus durement que tu ne jugerais un débutant.",
      },
      {
        titre: "Une bibliothèque qui grandit",
        sousTitre: "Des outils qui s'ajoutent, sans jamais se remplacer",
        texte: "À ce niveau, ta pratique de récupération et de bien-être s'enrichit : chaque nouvel outil rejoint ceux déjà acquis, pour te constituer une véritable bibliothèque de routines mobilisables selon ton besoin du moment.\n\nCe n'est pas un remplacement du travail précédent, mais un ajout.",
      },
    ],
    programmation: [
      {
    ...
    qcm: [
      {
        id: 'armure2-q1',
        question: "Laquelle des cinq qualités de l'armure organique renvoie à la tenségrité ?",
        choix: ["La Structure", "L'Équilibre", "La Résilience"],
        bonneReponse: 1,
      },
      {
        id: 'armure2-q2',
        question: "Quel mécanisme la théorie associe-t-elle au travail en profondeur (répétition consciente, test/erreur) ?",
        choix: ["L'hypertrophie des fibres sollicitées", "La densification des tissus conjonctifs", "La myélinisation des réseaux nerveux"],
        bonneReponse: 2,
      },
      {
        id: 'armure2-q3',
        question: "Quelle méthode est préconisée pour progresser en suspension passive ?",
        choix: ["Travailler à 80% de son temps max, sur 3 à 5 séries, avec 3 minutes de récupération", "Tenir jusqu'à l'échec sur chaque série pour repousser la limite", "Ajouter 10 secondes de tenue à chaque séance"],
        bonneReponse: 0,
      },
      {
        id: 'armure2-q4',
        question: "Quelle est l'erreur la plus courante sur l'Angola PU ?",
        choix: ["Garder le corps légèrement latéral au lieu de l'aligner", "Laisser le bassin s'affaisser vers le sol", "Perdre la rétraction des omoplates et laisser l'épaule de poussée monter vers l'oreille"],
        bonneReponse: 2,
      },
    ],
    contenuDefini: true,
  ...
  },
  {
    ...
    theorie: [
      {
        titre: "Intégration",
        sousTitre: "Faire fonctionner le corps comme un tout",
        texte: "Ce troisième niveau porte bien son nom : les outils travaillés en Fondations et en Consolidation s'intègrent maintenant les uns aux autres, et ton corps apprend à fonctionner comme un tout.\n\nCe niveau pose aussi les grands principes qui porteront toute la suite de ta pratique, quel que soit le domaine.",
      },
      {
        titre: "La répétition, matière première de l'entraînement",
        sousTitre: "Répéter sans jamais refaire exactement la même chose",
        texte: "Chaque mouvement trouve sa qualité dans la répétition. Mais répéter ne veut pas dire refaire mécaniquement le même geste : le physiologiste russe Nikolaï Bernstein parlait de « répétition sans répétition ». Chaque essai est légèrement différent du précédent, et c'est précisément cette variation, observée et corrigée, qui permet au système nerveux de trouver la meilleure solution.\n\nRépéter régulièrement et consciemment un mouvement permet de le comprendre en profondeur et de forger une connexion solide entre le corps et l'esprit — la base de tout apprentissage durable.\n\nC'est aussi pour cela que les consignes de ce niveau imposent un tempo précis ou un nombre de répétitions limité : la qualité de chaque répétition compte plus que leur nombre.",
        aRetenir: "La qualité de chaque répétition compte plus que leur nombre.",
      },
      {
        titre: "L'ambidextrie",
        sousTitre: "L'équilibre entre les deux côtés du corps",
        texte: "Développer la capacité à utiliser les deux côtés du corps de manière équilibrée renforce la coordination globale et la conscience corporelle.\n\nLa science apporte ici un argument étonnant : entraîner un seul membre fait aussi progresser le membre opposé, non entraîné. Ce phénomène, appelé éducation croisée, représente en moyenne un gain de force d'environ 12 % du côté non travaillé, et il s'explique par des adaptations du système nerveux plutôt que du muscle.\n\nTon côté fort peut donc réellement soutenir et « enseigner » ton côté faible — à condition de ne jamais oublier de travailler ce dernier directement, car rien ne remplace le travail direct.",
        aRetenir: "Ton côté fort aide ton côté faible, mais ne le dispense jamais d'un travail direct.",
        source: "Manca et al., « Cross-education of muscular strength following unilateral resistance training: a meta-analysis », European Journal of Applied Physiology, 2017.",
      },
      {
        titre: "L'analyse de l'erreur",
        sousTitre: "Une erreur est une information, pas un échec",
        texte: "Les erreurs sont des informations, pas des échecs. Les analyser en profondeur permet de comprendre les lacunes et de les transformer en occasions de progresser.\n\nPour que cette analyse porte ses fruits, la progression doit suivre une démarche évolutive : des objectifs accessibles, de difficulté toujours croissante, et interdépendants. Chaque compétence doit être suffisamment stable avant de passer à la suivante, car elle servira de base à un objectif de niveau supérieur.\n\nEt pense à célébrer chaque étape franchie, aussi petite soit-elle : c'est ce qui entretient la confiance et la motivation sur la durée.",
        aRetenir: "Des objectifs accessibles, croissants et reliés entre eux : c'est la condition pour que chaque erreur fasse progresser.",
      },
      {
        titre: "Les avantages de la pratique généraliste",
        sousTitre: "Une base large, pour un développement durable",
        texte: "Sortir de sa zone de confort et développer un large éventail de compétences, au-delà de ses goûts et de ses limites mentales du moment : voilà ce qu'encourage une pratique généraliste.\n\nLa recherche va dans ce sens. Une méta-analyse portant sur 6 096 athlètes, dont 772 parmi les meilleurs au monde, a montré que les athlètes de niveau mondial avaient pratiqué davantage de sports différents pendant l'enfance et l'adolescence, commencé leur discipline principale plus tard, et progressé plus lentement au début que les athlètes de niveau national.\n\nUne base large ralentit parfois les premiers progrès, mais elle rend le développement plus durable. Elle favorise la transversalité des compétences et la capacité d'adaptation — des atouts majeurs pour la santé, la performance et la longévité.",
        aRetenir: "Une progression lente mais large va souvent plus loin qu'une spécialisation précoce.",
        source: "Güllich, Macnamara et Hambrick, « What Makes a Champion? », Perspectives on Psychological Science, 2022.",
      },
      {
        titre: "La fabrique du multivers",
        sousTitre: "Des compétences qui se combinent et en créent de nouvelles",
        texte: "À ce stade, chaque compétence acquise devient une brique dans la construction d'un multivers de mouvements : un univers où les compétences ne s'additionnent pas simplement, mais se combinent, se transfèrent et en génèrent de nouvelles.\n\nUne mobilité de cheville construite pour le squat profond servira demain dans des dizaines de mouvements que tu ne connais pas encore. C'est ce transfert qui rend la pratique du Mouvement si riche, et qui favorise à la fois le dépassement de soi et la créativité.",
      },
      {
        titre: "Ouvrir des portes",
        sousTitre: "Les cinq branches s'ouvrent ensemble",
        texte: "L'armure organique a pour but d'ouvrir des portes. L'exploration commence par l'acquisition de compétences fondamentales, des tremplins vers des objectifs plus avancés — les « Grandes Portes » de ton parcours.\n\nCe niveau termine cette phase : il rend abordables, en même temps, les premiers objectifs des cinq branches. C'est pour cela qu'une fois l'armure organique complète, tu débloques le niveau 1 de Force, Figures, Flexibilité, Locomotion et Connexion en même temps — pas une branche après l'autre.\n\nL'armure, elle, ne sera jamais achevée : c'est une œuvre en progression, qui continuera de s'adapter à tes compétences et à tes aspirations.",
        aRetenir: "L'armure complète ouvre les cinq branches en même temps, et elle continuera d'évoluer avec toi.",
        image: "/mentorship/theorie/venn-5-branches.png",
        legende: "Les cinq branches se chevauchent volontairement : aucune ne se pratique jamais complètement isolée des autres. La « zone passerelle » au centre symbolise tout ce qui les relie.",
      },
    ],
    programmation: [
      {
    ...
    exercices: [
      ...
      },
      {
        ...
        consigne: "Coudes stables, à l'aplomb (à la verticale) au-dessus des mains, qui grattent les côtes à chaque répétition — pas les mains sous les épaules. Sangle abdominale engagée avec une rétroversion du bassin, amplitude complète, corps toujours parallèle au sol. Tempo : 3 temps de descente, 1 temps de remontée.",
        critereValidation: "1 série de 8 répétitions, tempo parfait (3 temps descente / 1 temps remontée). Pour progresser : travailler à 80% du maximum du jour sur 3 à 5 séries, avec 3 minutes de récupération entre chaque.",
        theme: 'force',
        outils: [
          { nom: 'Routine haut du corps', videoUrl: 'https://youtu.be/V6JDf7t7vPQ' },
          { nom: 'Push up genoux', videoUrl: 'https://youtu.be/lmGSzEfYHkE' },
          { nom: 'Protraction support', videoUrl: 'https://youtu.be/GlfSSKJpU-k' },
          { nom: 'Routine santé élastique', videoUrl: 'https://youtu.be/gdIxt_m35VE' },
      ...
      },
      {
        ...
        consigne: "Respecter le sens et la rotation du tirage. Rester gainé en hollow pour favoriser le travail des omoplates : toujours omoplates engagées avant le tirage, puis désengagées en fin de mouvement.",
        critereValidation: "3 séries de 5 répétitions, technique d'exécution parfaite, sans élan, engagement/désengagement des omoplates respecté à chaque répétition.",
        theme: 'force',
        outils: [
          { nom: 'Rowing anneaux', videoUrl: 'https://youtu.be/XzIFzhI-lrU' },
          { nom: 'Rowing bûcheron', videoUrl: 'https://youtu.be/SNBddEEl1UE' },
          { nom: 'Rétraction élastique', videoUrl: 'https://youtu.be/xSZHSDN3aaM' },
          { nom: 'Suspension active', videoUrl: 'https://youtu.be/1lpOQnht9jI' },
        ],
      },
      {
        ...
        theme: 'mobilite',
        outils: [{ nom: 'Routine assise complète', videoUrl: 'https://youtu.be/x2hWwXRc8tA' }],
      },
      {
        id: 'routine-stretch-actif-full', nom: 'Routine stretch actif 1 full', videoUrl: 'https://youtu.be/0XyyLXF1tAo',
        consigne: "Routine complète, chaque position tenue activement avec un engagement musculaire réel, pas juste relâché en bout d'amplitude. Maintien de 3 à 5 secondes sur chaque position, transitions douces et maîtrisées.",
        critereValidation: "Routine réalisée en entier, chaque position tenue activement 3 à 5 secondes, transitions maîtrisées.",
        theme: 'mobilite',
      },
      {
        id: 'front-squat', nom: 'Front squat', videoUrl: 'https://youtu.be/A-XHzbJnP7E',
        consigne: "Dos droit au maximum, sans enroulement du rachis, antéversion du bassin, coudes tirés vers le haut, épaules basses et omoplates rétractées. Prérequis : maîtriser le squat complet dos droit et talons au sol. Progression : partir d'une charge minimale et progresser vers l'objectif petit à petit, en respectant les plateaux naturels de la progression (5 à 10% de charge en plus à chaque palier).",
        critereValidation: "Entre 5 et 8 répétitions par série selon la charge du jour, technique parfaite (dos droit, antéversion, coudes hauts, omoplates rétractées), amplitude complète.",
        theme: 'mobilite',
      },
      {
        id: 'suspension-active-passive-3', nom: 'Suspension passive', videoUrl: 'https://youtu.be/1lpOQnht9jI',
        consigne: "Pas d'engagement des épaules ici, juste le grip, avec un verrouillage du pouce par-dessus l'index. Toujours travailler à 80% pour pouvoir, à terme, performer les 90 secondes. Pour progresser sur le grip en dehors de cet exercice : mêmes recommandations qu'aux niveaux précédents (balle de tennis, objets de plus en plus lourds à maintenir).",
        critereValidation: "90 secondes de maintien visées à terme ; en attendant, travailler à 80% de ce temps sur plusieurs séries, sans douleur.",
        theme: 'force',
      },
    ],
    qcm: [
      {
        id: 'armure3-q1',
        question: "Où doivent se placer les coudes pendant le push up clean ?",
        choix: ["Écartés à environ 45° du buste", "À l'aplomb des mains, en frôlant les côtes", "Au-dessus des épaules, mains placées sous la poitrine"],
        bonneReponse: 1,
      },
      {
        id: 'armure3-q2',
        question: "Quelle séquence scapulaire est attendue sur le rowing circle ?",
        choix: ["Omoplates engagées avant le tirage, désengagées en fin de mouvement", "Omoplates relâchées au départ, serrées en fin de tirage", "Omoplates serrées du début à la fin du mouvement"],
        bonneReponse: 0,
      },
      {
        id: 'armure3-q3',
        question: "Quelle position du bassin est demandée au front squat ?",
        choix: ["Rétroversion, comme dans le hollow", "Neutre strict, ni antéversion ni rétroversion", "Antéversion"],
        bonneReponse: 2,
      },
      {
        id: 'armure3-q4',
        question: "Lequel de ces éléments ne fait pas partie des trois principes de la Voie de la maîtrise présentés à ce niveau ?",
        choix: ["La répétition", "La spécialisation précoce dans un seul domaine", "L'ambidextrie"],
        bonneReponse: 1,
      },
    ],
    contenuDefini: true,
